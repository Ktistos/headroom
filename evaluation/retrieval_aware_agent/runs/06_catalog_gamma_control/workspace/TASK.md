...
Using zero-based indexing, copy the complete object at position **157** into `EXPECTED_RECORD`. Preserve all five keys and their exact values. Then run `python -m unittest -q`.
